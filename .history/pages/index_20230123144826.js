    ...
    <>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.center}>
         <p>Welcome To The WebTeam</p>
          <Image
            className={styles.logo}
            src="/icon/WebPhoto.jpeg"
            alt="Next.js Logo"
            width={540}
            height={300}
            priority
        ...
        <div className={styles.grid}>
          ...
          {information && information.map((info, index) => {
            if(info.department.toLowerCase() === "business") {
              return(
                <Card key={index} degree={info.degree} background-image= "linear-gradient(to bottom right, red, yellow)", font="10px"/>
              )
            }      
          })}
        </div>
